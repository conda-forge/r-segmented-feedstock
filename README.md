...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-segmented-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-segmented-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-segmented
# for installing globally
pixi global install r-segmented
```
...
It is possible to list all of the versions of `r-segmented` available on your platform:
...
```
pixi search r-segmented --channel conda-forge
```
